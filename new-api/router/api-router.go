...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		channelRoute.Use(middleware.AdminAuth())
		{
			...
			channelRoute.POST("/:id/test_keys", controller.TestChannelAllKeys)
		...
		logRoute.GET("/suspicious", middleware.AdminAuth(), controller.GetSuspiciousUsers)
		logRoute.PUT("/suspicious/:user_id/remark", middleware.AdminAuth(), controller.UpdateSuspiciousUserRemark)
