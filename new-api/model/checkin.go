...
// checkinTimezone 签到使用的时区，固定为北京时间（UTC+8）
// 签到日期以该时区的 0 点为分界线
var checkinTimezone = time.FixedZone("CST", 8*60*60)

// checkinToday 返回签到时区下的"今天"日期字符串
func checkinToday() string {
...
// HasCheckedInToday 检查用户今天是否已签到（北京时间 0 点重置）
